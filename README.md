...
- Switch to reading mode before exporting a PDF. And it is recommended to refresh once before export.
    - Because Obsidian has a cache between editing and reading modes, and no method is provided to precisely clear the cache currently.
...
(2025-02-15) Test in Obsidian v1.7.7 Sandbox Vault. left: Live Preview; right: Reading Mode:
