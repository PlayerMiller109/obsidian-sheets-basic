...
, codeblock = (source, el, ctx)=> ctx.addChild(new SheetElement(app, el, source))
...
function Load() {
  ...
  this.registerEvent(
    this.app.workspace.on('file-open', ()=> {
      sheetView.source = []; const view5 = this.app.workspace.getActiveFileView()
...
module.exports = class extends ob.Plugin {
  onload() {
    ...
    this.registerEditorExtension([ViewPlugin.fromClass(sheetEditor)])
    Load.call(this)
  }
  onunload() {}
}